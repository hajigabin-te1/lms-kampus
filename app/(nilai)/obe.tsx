...
export default function OBEScreen() {
  ...
  return (
    <SafeAreaView style={{ flex: 1 }} className="bg-[#ECECF8]">
      ...
      <View className="flex-row items-center px-4 py-4 bg-white shadow-sm border-b border-gray-100">
        ...
        <Text className="text-lg font-bold text-gray-800">Kurikulum OBE</Text>
      </View>

      {/* Konten Halaman */}
      <View className="flex-1 p-5 items-center justify-center">
        <View className="w-24 h-24 bg-blue-100 rounded-full items-center justify-center mb-4">
          <Ionicons name="ribbon" size={48} color="#3173C4" />
        </View>
        <Text className="text-xl font-bold text-gray-800 text-center mb-2">
          Detail Kurikulum OBE
        </Text>
        <Text className="text-sm text-gray-500 text-center px-4 leading-relaxed">
          Halaman ini nantinya akan menampilkan informasi lengkap mengenai
          capaian pembelajaran, evaluasi, dan metrik terkait Kurikulum OBE
